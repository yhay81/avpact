...
- Enforced the published v1.0 planning, contract, parent-memory upper-bound,
...
- Preserved the public v0.2 CLI and machine contracts. The digest-pinned v0.1
  compatibility corpus and all supported-platform tests continue to pass.
...
[Unreleased]: https://github.com/yhay81/avpact/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/yhay81/avpact/compare/v0.2.0...v0.3.0
